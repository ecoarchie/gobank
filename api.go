...
func (s *APIServer) handleCreateAccount(w http.ResponseWriter, r *http.Request) error {
	...
	// alternative approach to create empty struc to decode json into
	// createAccReq := CreateAccountRequest{} // in this case you shoul pass a pointer to that struct to json Decode func
